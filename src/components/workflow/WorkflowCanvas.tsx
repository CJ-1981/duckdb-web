...
interface WorkflowCanvasProps {
  ...
  previewLimit?: number;
  onFetchFullStats?: (nodeId: string) => Promise<any>;
  activeBottomTab?: number;
  setActiveBottomTab?: (tab: number) => void;
...
export function WorkflowCanvas({
  ...
  onFetchFullStats,
  activeBottomTab = 0,
  setActiveBottomTab: _setActiveBottomTab = () => {},
  setIsBottomPanelVisible: _setIsBottomPanelVisible = () => {},
}: WorkflowCanvasProps) {
